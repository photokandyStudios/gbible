...
@property NSUInteger greekText;
@property NSUInteger englishText;
...
@property (readwrite) NSUInteger currentBook;     // current visible book (1-based; Matthew = 40)
@property (readwrite) NSUInteger currentChapter;     // current visible chapter (1-based)
@property (readwrite) NSUInteger currentVerse;       // current visible verse (1-based)
@property (readwrite) NSUInteger topVerse;        // verse @ top of the screen
...
@property (readwrite) NSUInteger noteBook;
@property (readwrite) NSUInteger noteChapter;
@property (readwrite) NSUInteger noteVerse;                                // the reference of the current note (mid-edit)
